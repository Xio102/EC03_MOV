...
public class SupportActivity extends AppCompatActivity {
    ...
    private static final int CAPTURE_CODE = 1201;
        ...
        switch(requestCode){
            case PERMISSION_CODE:
                if(grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED){
                    ...
                    Toast.makeText(this, "Permission Deneg", Toast.LENGTH_SHORT).show();
                }
        }
    }
    ...
    private void openCamera(){
        ...
        values.put(MediaStore.Images.Media.DESCRIPTION, "From the Camara");
        imageUri = getContentResolver().insert(MediaStore.Images.Media.EXTERNAL_CONTENT_URI, values);

        Intent camaraIntent = new Intent(MediaStore.ACTION_IMAGE_CAPTURE);
        camaraIntent.putExtra(MediaStore.EXTRA_OUTPUT, imageUri);
        startActivityForResult(camaraIntent, CAPTURE_CODE);
    }
